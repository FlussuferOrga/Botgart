...
EN = {
    ...
    ...{
        ...
        "HELPTEXT_REMOVE_DISCORD_LOG": EN["HELPTEXT_PREFIX"] + "`<arbitary event type>` `<text channel from which messages of EN type should be removed>`",
...
DE = {
    ...
    ...{
        ...
        "HELPTEXT_REMOVE_DISCORD_LOG": DE["HELPTEXT_PREFIX"] + "`<Eventtyp (beliebig)>` `<Textkanal, aus dem Nachrichten dieses Typs entfernt werden sollen>`",

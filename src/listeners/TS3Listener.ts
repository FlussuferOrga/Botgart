...
* Doing so will throw two events "tagup" and "tagdown" for which other objects 
* can register via the this.eventEmitter object.
*/ 
...
//             const duser = g.members.find(m => m.id === registration.user);
//             if(crole && duser) {
//                 duser.addRole(crole);
//             }
...
//         this.eventEmitter.emit("tagdown", {
//             ...{
//                 "guild": g,
//                 "tsUID": tsUID,
//                 "account": account,

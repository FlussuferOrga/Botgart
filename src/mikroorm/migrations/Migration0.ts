...
export class Migration0 extends Migration {
    async up(): Promise<void> {
        ...
        this.addSql(
            "create table `permanent_roles` (`id` integer not null primary key autoincrement, `guild` text not null, `user` text not null, `role` text not null);"
        );
        ...
        this.addSql("create unique index `registrations_guild_gw2account_unique` on `registrations` (`guild`, `gw2account`);");

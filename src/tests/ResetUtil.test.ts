...
describe("ResetUtil", () => {
    it("upcoming reset before Friday (EU)", () => {
        assert.exactMoment(ResetUtils.getNextResetDateMoment(moment.tz("2019-11-12", "UTC")), moment.tz("2019-11-15 18:00:00", "UTC"));
    });
    ...
    it("upcoming reset before Friday (NA)", () =>
        assert.exactMoment(ResetUtils.getNextResetDateMoment(moment.tz("2019-11-12", "UTC"), WvwRegion.NA), moment.tz("2019-11-16 02:00:00", "UTC")));

    it("upcoming reset after Friday", () =>
        assert.exactMoment(ResetUtils.getNextResetDateMoment(moment.tz("2019-11-16", "UTC")), moment.tz("2019-11-22 18:00:00", "UTC")));

    it("upcoming reset after Friday (Summertime)", () => {
        assert.sameMoment(ResetUtils.getNextResetDateMoment(moment.utc("2019-08-16")), moment.tz("2019-08-16 20:00", "Europe/Berlin"));
    });
    ...
    it("upcoming reset between years", () =>
        assert.exactMoment(ResetUtils.getNextResetDateMoment(moment.tz("2019-12-31", "UTC")), moment.tz("2020-01-03 18:00:00", "UTC")));

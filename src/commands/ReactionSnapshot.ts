...
export class ReactionSnapshot extends BotgartCommand {
                ...
                args: [
                    {
                        ...
                        type: async (message: discord.Message, phrase: string) => {
                            ...
                            if (match !== null) {
                                ...
                                if (guild !== undefined) {
                                    const channel: discord.TextChannel | undefined = guild.channels.cache.find(
                                        (c) => c instanceof discord.TextChannel && c.id === channelId
    ...
    async command(message: discord.Message, responsible: discord.User, guild: discord.Guild, args): Promise<void> {
        ...
        for (const split of splitMessage(listings.join("\n\n"), { prepend: "_ _\n" })) {
